...
import static navigo.app.activity.MainActivity.LOG;
...
import navigo.app.fragments.CreateRoute;
import navigo.app.DBHelper;
import navigo.app.fragments.DownloadedCities;
import navigo.app.DrawerAdapter;
import navigo.app.fragments.FirstStartFragment;
import navigo.app.ItemModel;
import navigo.app.fragments.MyPlaces;
import navigo.app.R;
import navigo.app.fragments.Settings;
...
public class MapsActivity extends FragmentActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstStartFragment = new FirstStartFragment(fragmentManager, map, this);

        String cacheCity = sPref.getString(cityName+"cache", "");
    ...
    private ItemModel[] fillDataModel() {
        return new ItemModel[]{
                ...
                new ItemModel(R.drawable.offline, "offline карты"),
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                case 0:
                    ...
                    fragmentManager.beginTransaction().hide(fragment = new DownloadedCities(map,MapsActivity.this)).commit();
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    fragment = new DownloadedCities(map, MapsActivity.this);
                    break;
                case 4:
